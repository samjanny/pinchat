...
The experimental group-room creation endpoint is disabled unless the server
operator explicitly sets `GROUP_CHAT_ENABLED=true`. This is a deployment
feature gate only; it does not alter MLS wire formats, transcript hashes, or
